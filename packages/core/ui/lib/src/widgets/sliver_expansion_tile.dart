/*
 * This code is taken from the wow_shopping repository by the author slightfoot.
 * Original source: https://github.com/slightfoot/wow_shopping/blob/1e96eedcaf4ee92c8f204136f9ebcba1ce2a7572/lib/widgets/sliver_expansion_tile.dart
 * License: No license provided in the original repository.
 *
 * Description:
 * Flutter does not yet natively support a Sliver-based ExpansionTile.
 * I found this implementation in the wow_shopping repository after being referenced
 * in a Flutter issue discussion. It is used to implement expandable sections
 * in sliver-based scroll views.
 *
...
import 'package:ui/src/widgets/sliver.dart';

const emptySliver = SliverSizedBox(height: 0, width: 0);
