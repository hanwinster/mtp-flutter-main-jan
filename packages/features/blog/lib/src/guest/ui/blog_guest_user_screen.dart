...
import 'blog_guest_user_screen_entry.dart';

class BlogGuestUserScreen extends StatelessWidget {
  const BlogGuestUserScreen({
    super.key,
      ...
      body: Padding(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              MtpAssets.images.blogGuestUser.image(
                width: 250,
                height: 250,
              ),
              Text(context.l10n.blogLableGuestUserMessage),
