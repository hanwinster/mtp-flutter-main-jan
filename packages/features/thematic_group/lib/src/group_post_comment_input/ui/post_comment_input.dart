    ...
    return MultiBlocListener(
        ...
        BlocListener<PostCommentInputBloc, PostCommentInputState>(
          ...
          listener: (context, state) {
            if (state.commentCreatingStatus is UiStateSuccess) {
              Navigator.pop(context, state.commentCreatingStatus.dataOrNull);
        ...
        BlocListener<PostCommentInputBloc, PostCommentInputState>(
          ...
          listener: (context, state) {
            if (state.commentUpdatingStatus is UiStateSuccess) {
              Navigator.pop(context, state.commentUpdatingStatus.dataOrNull);
      ...
      child: Column(
        ...
        children: [
          ...
          TextInput(
            initialText: widget.comment?.description ?? '',
          ),
