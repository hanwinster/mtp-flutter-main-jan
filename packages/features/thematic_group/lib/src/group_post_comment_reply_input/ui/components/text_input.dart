...
class _TextInputState extends State<TextInput> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<PostCommentReplyInputBloc, PostCommentReplyInputState>(
      listenWhen: (previous, current) =>
          previous.textState != current.textState,
      listener: (context, state) {
        _controller.text = state.textState.value;
      },
      child: BlocBuilder<PostCommentReplyInputBloc, PostCommentReplyInputState>(
          ...
          return MtpTextField(
            ...
            onChanged: (value) {
              context
                  ...
                  .add(PostCommentReplyInputTextChanged(value));
            },
