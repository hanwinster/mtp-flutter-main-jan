    ...
    return BlocConsumer<EditProfileBloc, EditProfileState>(
      ...
      builder: (context, state) {
        return MtpOutlineTextField(
          ...
          labelText: context.l10n.editProfileLabelName,
          prefixIcon: const Icon(Icons.badge_outlined),
          textInputAction: TextInputAction.next,
          onSubmitted: (_) => widget.onFieldSubmitted(),
          focusNode: widget.focusNode,
          onChanged: (value) {
            context.read<EditProfileBloc>().add(EditProfileFullNameChanged(value));
          },
          errorText: state.fullNameError?.resolveFullnameErrorMessage(context),
        );
      },
    );
  }
